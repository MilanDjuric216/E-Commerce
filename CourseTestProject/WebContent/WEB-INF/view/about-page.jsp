...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <figure class="text-center">
                                    <img src="img/slide1.jpg" class="img-responsive" alt="img"/>
                                </figure>
                            </div>

                            <div class="item">
                                <figure class="text-center">
                                    <img src="img/slide2.jpg" class="img-responsive" alt="img"/>
                                </figure>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <article>
                                ...
                                <a href="#">View more <img src="img/arrow.png" alt="arrow"/></a>
        ...
        <footer>
            <section>
                <div class="container">
                    <a href="index.html"><img src="img/logoFooter.png" class="center-block" alt="logo"/></a>
