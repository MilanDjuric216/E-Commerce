                ...
                <div class="row">
                    <div class="col-md-6">
                        <article class="text-center">
                            <h2>Sign in</h2>
                            <form id="myForm" role="form" data-toggle="validator" action="loginConfirmation">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">@</span>
                                        <input name="email" type="email" class="form-control" placeholder="example@example.com" data-error="Please type valid e-mail address!" required>
                                    </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="input-group">
                                        <input name = "password" type="password" data-minlength="6" class="form-control" aria-describedby="basic-addon1" id="password" placeholder="Password" required>
                                        <span class="input-group-addon"><span class="eye fa fa-eye"></span></span>
                                    </div>
                                    <div class="help-block">Minimum number of characters is 6</div>
                                </div>
                                <button>Confirm</button>

                                <a href="ForgotPassword.html" class="center-block">Forgot a password?</a>
                            </form>
                    ...
                    <div class="col-md-6">
                        <article class="text-center">
                            ...
                            <p class="text-justify">
                                <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                    do eiusmod tempor incididunt ut labore et dolore magna aliqua.</strong>
                            ...
                            <p>Tel.<a href="tel:+38111/488-3071"> +38111/488-3071</a></p>
                            <p>Fax:<a href="tel:+38111/488-3071"> +38111/488-3071</a></p>
                            <p>E-mail:<a href="mailto:example@rxample.com"> example@rxample.com</a></p>
                        </article>
                    </div>
                </div>
            </div>
